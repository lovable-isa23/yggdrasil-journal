...
// Beta Reservation price ID
const PRICE_ID = "price_1SSWY7G7xaR4wMDuiu5qFvf0";
...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`[CREATE-CHECKOUT] Creating checkout for user: ${user.id}, email: ${user.email}`);
    ...
    const origin = req.headers.get("origin") || "https://yggdrasil.lovable.app";
